...
body::before {
  ...
  width:100%;
  height:100vh;
  background:url(https://peyng.github.io/miya-jazz-inn-2022/20221030_002.JPG) center/cover no-repeat; /*fixedをトル！*/
...
<body onload="alert('Miya Jazz Inn 2022の動画集です。来年もまた見せてね〜(^o^)/')">
<p class="note">
  モバイル端末をお使いの場合は、画面を横向きにすると
  より見やすくご覧頂けます。
</p>
	
<p><a href="https://peyng.github.io/River-Jewelries-home/">Home</a>>miya jazz inn 2022</p>
<h1><span class="yellow"><marquee behavior="left">!!! 2022年10月30日(日)_River Jewelries@宇都宮オリオンスクエア !!!</marquee></span></h1>
...
<a href="20221030_001.JPG" data-lightbox="abc"><img src="20221030_001.JPG" alt="サンプル画像" width="900" /></a>
<br>
<!--
...
<p align="right"><marquee direction="left" scrollamount="10" width="80%">背景はMiya Jazz Inn 2022 パンフレット ~~~ (^^)/</marquee></p>
...
<!-- フッタ -->
 <footer>
	<span class="grey">Copyright 2022/10/30 S.Hada</span>
